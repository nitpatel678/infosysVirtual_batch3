...
def evaluate(
    ...
    verdict_details = {
        ...
        "verdict_tag": verdict_data.get("verdict_tag", final_verdict),
        ...
        "quality_gates": verdict_data.get("quality_gates", {}),
        "gates_passed": verdict_data.get("gates_passed", 0),
        "total_gates": verdict_data.get("total_gates", 5),
        "all_gates_cleared": verdict_data.get("all_gates_cleared", False),
        "breached_gates": verdict_data.get("breached_gates", []),
    ...
    for idx, row in enumerate(rows, 1):
        ...
        if eval_res is not None:
            ...
            verdict_details = {
                ...
                "status": verdict,
                "verdict_tag": verdict_data.get("verdict_tag", verdict),
